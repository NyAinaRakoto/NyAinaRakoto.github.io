...
My current research project involves leveraging remote sensing techniques to address the challenges posed by invasive grassland plants. I am focusing on using remote sensing, particularly imaging spectroscopy, coupled with in situ observations and modeling to detect invasive plants and assess their impacts on aboveground and belowground grassland ecosystems. My research aims to contribute to understanding how remote sensing can be used in invasive species studies beyond mapping their presence in the ecosystem. Furthermore, my research can contribute to providing actionable information for managing invasive plants and maintaining ecosystem functioning and biodiversity. 
